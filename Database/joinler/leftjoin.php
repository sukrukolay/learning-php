...
<body>
    ...
    */
    ...
    $Sorgu  = $VeriTabaniBaglantisi->query("SELECT *FROM uyeler LEFT JOIN siparisler ON uyeler.id = siparisler.uyeid ",PDO::FETCH_ASSOC);
    if($Sorgu){
    ...
    | Muhammed Şirin | 22 | Ağrı | | |
    | İsmail Kartal | 60 | İstanbul | | |    */
    ?>
</body>
</html>