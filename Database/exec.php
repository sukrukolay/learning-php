...
<body>
        <?php
            ...
            */
            ...
            $Sorgu  = $VeritabaniBaglantisi->exec("SELECT *from uyeler"); // exec() metodu SELECT işlemlerinde kullanılmamalıdır. SELECT işlemlerinde query() metodu tercih edilmelidir.
            ...
            İşlemde Etkilenen Kayıt Sayısı: 0
            */
        ?>
</body>
</html>