...
<body>
    ...
    */
    ...
    // dbname=extraegitim olan veritabanında bulunan son isimli sütunun belirtilen özelliklerini değiştirir.
    $Sorgu  = $VeritabaniBaglantisi->query("ALTER TABLE uyeler MODIFY son timestamp DEFAULT current_timestamp NOT NULL ");
    if($Sorgu){
