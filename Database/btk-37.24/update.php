...
<body>
    ...
    */
    ...
    /*// alttaki 2 satır da aynı işi yapmaktadır.
    $Guncelle  = $VeriTabaniBaglantisi->prepare("UPDATE uyeler SET adisoyadi = ?  WHERE id=10");
    $Guncelle->execute(['Volkan Alakent']);
    */
     $Guncelle  = $VeriTabaniBaglantisi->prepare("UPDATE uyeler SET adisoyadi = 'Volkan Alakent' WHERE id=10");
     $Guncelle->execute();
        if($Guncelle){
