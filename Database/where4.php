...
<body>
    <?php
        ...
        */
        ...
        // yas değeri 38 ve 40 arasında olMAYAN kayıtları getir.
        //$Sorgu  = $VeriTabaniBaglantisi->query("SELECT *FROM kayitlar WHERE yas NOT BETWEEN 38 AND 40" , PDO::FETCH_ASSOC);


        // yas değeri 38 ve 40 arasında olan kayıtları getir.
        $Sorgu  = $VeriTabaniBaglantisi->query("SELECT *FROM kayitlar WHERE yas BETWEEN 38 AND 40" , PDO::FETCH_ASSOC);
        if($Sorgu){
