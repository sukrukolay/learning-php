...
<body>
    ...
    */
    ...
    $Sorgu  = $VeriTabaniBaglantisi->prepare("SELECT *FROM uyeler WHERE id>:ilkkosul and id<:ikincikosul" ); // sorgu prepare() sayesinde hazırlandı.
    $Sorgu->execute(array(":ilkkosul"=> 4,":ikincikosul"=> 8)); // sorgu execute() ile çalıştırıldı. 
    if($Sorgu){
