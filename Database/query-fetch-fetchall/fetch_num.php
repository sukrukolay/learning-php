...
<body>
    <?php
        ...
        */
        ...
        // PDO::FETCH_NUM kullanılacaksa sütun numaraları yazılmak zorundadır. Diğer türlü $Satirlar["id"] vb gibi yazımlar hatalıdır.
        $Sorgu  = $VeritabaniBaglantisi->query("SELECT * FROM kayitlar" , PDO::FETCH_NUM); 
        if($Sorgu){
            foreach ($Sorgu as $Satirlar) {
                echo "ID                        : ".$Satirlar[0]."<br/>";
                echo "ADI SOYADI                : ".$Satirlar[1]."<br/>";
                echo "YAŞ                       : ".$Satirlar[2]."<br/>";
                echo "YAŞADIĞI ŞEHİR            : ".$Satirlar[3]."<br/>";
                echo "SİTEYE GİRİŞ SAYISI       : ".$Satirlar[4]."<br/>";
                echo "SİPARİŞ SAYISI            : ".$Satirlar[5]."<br/>";
                echo "SİPARİŞ TOPLAM TUTARI     : ".$Satirlar[6]."<br/><br/>";
            }
        }
        else{
