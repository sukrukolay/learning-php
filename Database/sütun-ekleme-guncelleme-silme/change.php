...
<body>
    ...
    */
    ...
    // dbname=extraegitim olan veritabanında bulunan ilk isimli sütunun ismini son yapar ve türünü varchar(5) yapar.
    $Sorgu  = $VeritabaniBaglantisi->query("ALTER TABLE uyeler CHANGE ilk son varchar(5)");
    if($Sorgu){
